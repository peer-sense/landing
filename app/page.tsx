        ...
        <footer className="border-t border-gray-800 pt-12">
          <div className="max-w-5xl mx-auto flex flex-col items-center">
            ...
            <p className="text-sm text-muted-foreground">
              © 2024 Peer Sense AI. All rights reserved.
            </p>
          </div>
        </footer>
      </section>
      ...
      {features.map((feature, index) => (
        ...
        >
          ...
          >
            <path
              fillRule="evenodd"
              d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1. Continuing the file content from where it left off:

```typescript
414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
              clipRule="evenodd"
            />
          </svg>
          <span>{feature}</span>
